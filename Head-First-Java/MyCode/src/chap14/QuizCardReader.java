...
public class QuizCardReader {
    ...
    private static ArrayList cardList;
    private static QuizCard currentCard;
    private static Iterator cardIterator;
   ...
   public static class OpenMenuListener implements ActionListener {
        public void actionPerformed(ActionEvent ev) {
   ...
   private static void makeCard(String lineToParse) {
